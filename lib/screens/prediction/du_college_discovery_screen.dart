...
class DuCollegeDiscoveryScreen extends StatefulWidget {
  ...
  @override
  State<DuCollegeDiscoveryScreen> createState() =>
      _DuCollegeDiscoveryScreenState();
}
...
class _DuCollegeDiscoveryScreenState extends State<DuCollegeDiscoveryScreen> {
  ...
  Future<void> _fetchColleges() async {
    try {
      ...
      final List<DuCollegeData> colleges = (res as List)
          .map((c) => DuCollegeData.fromJson(c))
          .toList();
      setState(() {
    ...
    setState(() {
      _filteredColleges = _allColleges.where((c) {
        final matchSearch =
            ...
            (c.nearestMetro?.toLowerCase().contains(
        ...
        final matchCampus =
            ...
            campus == selected ||
            (selected == 'off campus' &&
                (campus.isEmpty || campus.contains('off')));
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 4),
                        Text(
                          college.nearestMetro ?? 'DU Campus',
                          style: GoogleFonts.inter(
                            fontSize: 11,
                            color: Colors.grey,
                          ),
